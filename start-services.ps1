...
$paneManagerClass.SetInitialCommand("powershell php artisan serve");
$paneManagerClass.AddPane("powershell npm run dev", '-V', 0.5);
$paneManagerClass.AddPane("powershell php artisan queue:listen", '-H', 0.5);
$paneManagerClass.TargetPane(0);
$paneManagerClass.AddPane("powershell php artisan reverb:start --host 127.0.0.1 --debug", '-H', 0.5);
